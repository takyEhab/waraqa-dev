  ...
  >
    <div class="modal-dialog custom-with-modal-dialog">
      <div class="modal-content text-start">
        ...
        >
          <h5 class="m-0">Edit Guardian's information</h5>
          <button
            type="button"
              ...
              <div class="row flex-wrap">
                ...
                <div class="col-12 col-md mt-3">
                  ...
                  <select
                    ...
                    :disabled="disablePaymenttypeSelection"
                    @change="
                ...
                <div class="col-12 col-md mt-3">
                  <label class="f-color-3 mb-1">Transfer price</label>
                  <input
                    type="text"
                    class="form-control"
                    placeholder="null"
    ...
    getUserData() {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.disablePaymenttypeSelection = this.data[0].paymentType
            ? true
            : false; //Accebility only once (if not exists).
